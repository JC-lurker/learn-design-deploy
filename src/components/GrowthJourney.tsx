  ...
  return (
    <section className="bg-white py-16 md:py-24">
      <div className="container mx-auto px-4 md:px-8 lg:px-16 text-center">
        <h2 className="text-3xl md:text-4xl font-bold text-brand-text mb-8">Empower Your Growth Journey</h2>
        <div className="relative aspect-video bg-gray-200 rounded-xl flex items-center justify-center max-w-4xl mx-auto mb-8 shadow-lg">
